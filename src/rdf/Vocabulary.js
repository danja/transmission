...
export const vocabulary = Object.freeze({
  ...
  trn: Object.freeze({
    ...
    arrangementLength: `${TRN}arrangementLength`, midiClips: `${TRN}midiClips`, gainLanes: `${TRN}gainLanes`,
    clipId: `${TRN}clipId`, targetNode: `${TRN}targetNode`, startBeat: `${TRN}startBeat`, lengthBeats: `${TRN}lengthBeats`, notes: `${TRN}notes`,
    durationBeats: `${TRN}durationBeats`, pitch: `${TRN}pitch`, velocity: `${TRN}velocity`, channel: `${TRN}channel`,
