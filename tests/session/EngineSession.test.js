...
function bridge() {
  return {
    createEngine: vi.fn(), loadProject: vi.fn(), configureTransport: vi.fn(), startAudio: vi.fn(), stopAudio: vi.fn(), dispose: vi.fn()
  }
}
...
describe('EngineSession', () => {
  it('compiles before loading and controls lifecycle', () => {
    ...
    expect(native.createEngine).toHaveBeenCalledOnce()
